...
type PageType = 'home' | 'login' | 'register' | 'about' | 'more' | 'bestsellers' | 'gallery' | 'artist-dashboard';
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative backdrop-blur-[0.5px]">
        ...
        {/* Footer - shown on all pages except artist dashboard */}
        {currentPage !== 'artist-dashboard' && <Footer />}
      </div>
