...
export function Header({ onNavigateToLogin, onNavigateToRegister, onNavigateToHome, onNavigateToAbout, onNavigateToMore, onNavigateToBestSellers, onNavigateToGallery, currentPage }) {
