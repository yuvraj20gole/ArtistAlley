...
export function Register({ onNavigateToHome, onNavigateToLogin, defaultRole }) {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Welcome to ArtistAlley! Your ${formData.userType} account has been created successfully.`);
