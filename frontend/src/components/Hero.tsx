  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100/80 via-pink-50/70 to-purple-100/80"></div>
        <div className="absolute inset-0 bg-gradient-to-tl from-pink-100/60 via-transparent to-purple-100/50"></div>
          ...
          <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              <linearGradient id="brush2" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="currentColor" className="text-pink-400/35" />
                <stop offset="100%" stopColor="currentColor" className="text-purple-400/30" />
              </linearGradient>
            </defs>
