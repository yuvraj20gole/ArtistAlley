...
interface HeaderProps {
  ...
  currentPage: 'home' | 'login' | 'register' | 'about' | 'more' | 'bestsellers' | 'gallery' | 'artist-dashboard' | 'buyer-dashboard' | 'admin-dashboard' | 'google-callback' | 'role-selection';
  user: User | null;
  isAuthenticated: boolean;
  onLogout: () => void;
}

export function Header({ onNavigateToLogin, onNavigateToRegister, onNavigateToHome, onNavigateToAbout, onNavigateToMore, onNavigateToBestSellers, onNavigateToGallery, onNavigateToArtistDashboard, currentPage, user, isAuthenticated, onLogout }: HeaderProps) {
