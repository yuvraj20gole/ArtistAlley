...
export function Footer({ 
  ...
  const handleLinkClick = (link: string) => {
    switch (link) {
      ...
      case 'Best Sellers':
      case 'New Arrivals':
        if (onNavigateToBestSellers) onNavigateToBestSellers();
        break;
      case 'Sell Your Art':
      case 'Artist Resources':
      ...
      case 'Help Center':
        ...
        break;
      default:
        // For other links, you can add more specific handlers or keep as is
        break;
    }
  };
            ...
            <div className="flex space-x-3">
              {socialIcons.map(({ Icon }, index) => (
                <Icon 
                  ...
                  style={{ color: '#2C2C2C' }}
                  onMouseEnter={(e) => (e.currentTarget as unknown as HTMLElement).style.color = '#9B5DE5'}
                  onMouseLeave={(e) => (e.currentTarget as unknown as HTMLElement).style.color = '#2C2C2C'}
                />
              ))}
            </div>
          </div>
          ...
          {[
            ...
            <div key={section.title}>
              <h3 
                ...
                style={{ color: '#2C2C2C' }}
                onMouseEnter={(e) => (e.currentTarget as HTMLElement).style.color = '#9B5DE5'}
              ...
              <ul className="space-y-3 text-sm">
                {section.links.map((link) => (
                  <li
                    ...
                    style={{ color: '#2C2C2C' }}
                    onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#9B5DE5'}
