...
export function ComingSoon({ onNavigateToMore }: ComingSoonProps) {
  ...
  const handleNotifyMe = () => {
    ...
    toast.success('🎉 You\'re now subscribed! We\'ll notify you when new features are released.');
          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-purple-200 rounded-lg focus:border-purple-400 focus:ring-purple-400/20 text-gray-700 placeholder-gray-500"
